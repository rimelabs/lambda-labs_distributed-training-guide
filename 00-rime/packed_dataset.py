...
def pad_and_collate(data):
    ...
    return {
        ...
        # Don't supply attention_mask (which causes HF to not use FA) but only supply position_ids
        # which apparently should get passed to FA: https://huggingface.co/blog/packing-with-FA2
    }
